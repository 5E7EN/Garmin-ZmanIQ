...
module JewishCalendarModule {
    module HebrewCalendar {
        class JewishDate {
            ...
            hidden const JEWISH_EPOCH = -1373429;
            hidden const DAY_FORWARD_DURATION = new Time.Duration(24 * 60 * 60);
            ...
            hidden const ELAPSED_DAYS_FOR_YEAR = {
                5776 => 2109283,
                5777 => 2109668,
                5778 => 2110021,
                5779 => 2110375,
            ...
            hidden function gregorianDateToAbsDate(year, month, dayOfMonth) {
            ...
            hidden function getLastDayOfGregorianMonth(month, year) {
                if (month == 2) {
            ...
            hidden function jewishDateToAbsDate(year, month, dayOfMonth) {
            ...
            hidden function getDaysSinceStartOfJewishYear(year, month, dayOfMonth) {
            ...
            function getLastMonthOfJewishYear(year) {
                return isJewishLeapYear(year) ? ADAR_II : ADAR;
            }

            function getJewishCalendarElapsedDays(year) {
            ...
            hidden function getDaysInJewishMonth(month, year) {
            ...
            hidden function getDaysInThisJewishMonth() {
                return getDaysInJewishMonth(getJewishMonth(), getJewishYear());
            }

            hidden function isCheshvanLong(year) {
                return getDaysInJewishYear(year) % 10 == 5;
            }

            hidden function getDaysInJewishYear(year) {
            ...
            hidden function isKislevShort(year) {
            ...
            hidden function getJewishMonthOfYear(year, month) {
                var isLeapYear = isJewishLeapYear(year);
                return ((month + (isLeapYear ? 6 : 5)) % (isLeapYear ? 13 : 12)) + 1;
            }

            hidden function isJewishLeapYear(year) {
        ...
        class JewishCalendar extends JewishDate {
            ...
            // const EREV_CHANUKAH = 20;// probably remove this
            const CHANUKAH = 21;
            ...
            function getYomTovIndex() {
                ...
                if (jewishMonth == NISSAN) {
                    if (jewishDay == 14) {
                        return EREV_PESACH;
                    } else if (getJewishDay() == 15 || getJewishDay() == 21 || (!inIsrael && (getJewishDay() == 16 || getJewishDay() == 22))) {
                        return PESACH;
                    } else if ((getJewishDay() >= 17 && getJewishDay() <= 20) || (getJewishDay() == 16 && inIsrael)) {
                    ...
                    if (
                        ...
                        ((getJewishDay() == 26 && dayOfWeek == 5) ||
                            ...
                            (getJewishDay() == 27 && dayOfWeek == 3) ||
                            (getJewishDay() == 27 && dayOfWeek == 5))
                    ) {
                        return YOM_HASHOAH;
                    }
                    ...
                    if (
                        useModernHolidays &&
                        ((getJewishDay() == 4 && dayOfWeek == 3) || ((getJewishDay() == 3 || getJewishDay() == 2) && dayOfWeek == 4) || (getJewishDay() == 5 && dayOfWeek == 2))
                    ) {
                    ...
                    if (
                        useModernHolidays &&
                        ((getJewishDay() == 5 && dayOfWeek == 4) || ((getJewishDay() == 4 || getJewishDay() == 3) && dayOfWeek == 5) || (getJewishDay() == 6 && dayOfWeek == 3))
                    ) {
                    ...
                    if ((getJewishDay() == 17 && dayOfWeek != 7) || (getJewishDay() == 18 && dayOfWeek == 1)) {
                        return SEVENTEEN_OF_TAMMUZ;
                    }
                } else if (jewishMonth == AV) {
                    // if Tisha B'av falls on Shabbos, push off until Sunday
                    if ((dayOfWeek == 1 && getJewishDay() == 10) || (dayOfWeek != 7 && getJewishDay() == 9)) {
                        return TISHA_BEAV;
                    ...
                    if (getJewishDay() == 1 || getJewishDay() == 2) {
                        return ROSH_HASHANA;
                    } else if ((getJewishDay() == 3 && dayOfWeek != 7) || (getJewishDay() == 4 && dayOfWeek == 1)) {
                    ...
                    if (getJewishDay() == 1 || getJewishDay() == 2 || (getJewishDay() == 3 && JewishDate.isThisKislevShort())) {
                        return CHANUKAH;
                    } else if (getJewishDay() == 10) {
                    ...
                    if (!JewishDate.isThisJewishLeapYear()) {
                        ...
                        if (((getJewishDay() == 11 || getJewishDay() == 12) && dayOfWeek == 5) || (getJewishDay() == 13 && !(dayOfWeek == 6 || dayOfWeek == 7))) {
            ...
            function isTaanis() {
                var holidayIndex = getYomTovIndex();
                return (
                    holidayIndex == SEVENTEEN_OF_TAMMUZ ||
            ...
            function getDayOfChanukah() {
                if (isChanukah()) {
                    if (getJewishMonth() == KISLEV) {
                        ...
                        // teves
                        // Modified
                        return isKislevShort(getJewishYear()) ? getJewishDay() + 5 : getJewishDay() + 6;
                    }
                } else {
                    return -1;
                }
